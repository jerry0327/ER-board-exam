...
import type { AudioPlayerDockController } from "./audio-player-dock";

let audioPlayerDockModulePromise: Promise<typeof import("./audio-player-dock")> | null = null;

function loadAudioPlayerDock() {
  if (!audioPlayerDockModulePromise) {
    audioPlayerDockModulePromise = import("./audio-player-dock");
  }
  return audioPlayerDockModulePromise;
}

const AudioPlayerDock = lazy(loadAudioPlayerDock);
...
export default function AudioPlayerProvider({ children }: { children: ReactNode }) {
  ...
  const dockController: AudioPlayerDockController | null = current ? {
    current,
    phase,
    loadProgress,
    position,
    ...
    <AudioPlayerContext.Provider value={value}>
      ...
      {dockController && (
        <Suspense fallback={null}>
          <AudioPlayerDock controller={dockController} />
        </Suspense>
      )}
